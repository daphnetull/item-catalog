...
def gconnect():
	# verifying the server-generated state token matches what was passed from url
...
def catalog():
	...
	if 'email' not in login_session:
		...
		is_logged_in = True
	return render_template('catalog.html', category = category, is_logged_in = is_logged_in, items = items)
...
def items(category_id):
	...
	if 'email' not in login_session:
		...
		print 'yup'
		is_logged_in = True
	return render_template('items.html', category = category, is_logged_in = is_logged_in, items = items)
